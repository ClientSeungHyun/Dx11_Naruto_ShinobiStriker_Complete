...
public:
	...
	HRESULT Create_Texture(const _wstring& strFilePath, const _wstring& strTargetTag);
	HRESULT Load_Texture(const _wstring& strTargetTag, const _wstring& strTextureFilePath);
