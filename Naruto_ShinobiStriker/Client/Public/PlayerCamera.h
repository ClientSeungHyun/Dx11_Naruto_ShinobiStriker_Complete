...
private:
	...
	_float3					m_vSkillCameraStartPos = {}; 
	_float3					m_vSkillCameraEndPos = {};
	_float3					m_vSkillCameraAt = {};

	_float					m_fSkillFovy = {};
	_float					m_fSkillLerpTime = {};
	_float					m_fSkillLerpDuration = {};

private:
	void Rotation_CustomLevel(_float fTimeDelta);
