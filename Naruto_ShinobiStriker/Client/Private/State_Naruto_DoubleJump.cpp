...
CState_Naruto_DoubleJump::CState_Naruto_DoubleJump(CFsm* pFsm, CPlayer* pPlayer)
	:CState{ pFsm }
	, m_pPlayer{ pPlayer }
{
}

HRESULT CState_Naruto_DoubleJump::Initialize(_uint iStateNum)
{
	m_iAnimation_DoubleJump = m_pPlayer->Get_Model()->Get_AnimationIndex("Naruto_DoubleJump", 2.6);
	m_iStateNum = iStateNum;

	return S_OK;
}

HRESULT CState_Naruto_DoubleJump::Start_State(void* pArg)
{
...
void CState_Naruto_DoubleJump::Update(_float fTimeDelta)
{
	Move(fTimeDelta);
...
void CState_Naruto_DoubleJump::End_State()
{
}

void CState_Naruto_DoubleJump::Set_JumpTargetPos()
{
...
void CState_Naruto_DoubleJump::Jump()
{
	_vector vJumpDir;
	_vector vJumpPower = XMVectorSet(1.f, 18.f, 1.f, 0.f);
...
void CState_Naruto_DoubleJump::Move(_float fTimeDelta)
{
...
CState_Naruto_DoubleJump* CState_Naruto_DoubleJump::Create(CFsm* pFsm, CPlayer* pPlayer, _uint iStateNum)
{
	CState_Naruto_DoubleJump* pInstance = new CState_Naruto_DoubleJump(pFsm, pPlayer);
