...
HRESULT CTerrain::Initialize(void* pArg)
{
	...
	//m_pGameInstance->AddScene_ColMesh(this, TEXT("Terrain"));
...
HRESULT CTerrain::Ready_Components()
{
	...
	/* FOR.Com_Texture */
	if (FAILED(__super::Add_Component(m_iLevelIndex, TEXT("Prototype_Component_Texture_Terrain"),
		TEXT("Com_Texture"), reinterpret_cast<CComponent**>(&m_pTextureCom))))
		return E_FAIL;

	/* FOR.Com_VIBuffer */
	if (FAILED(__super::Add_Component(m_iLevelIndex, TEXT("Prototype_Component_VIBuffer_Terrain"),
