...
CGameObject* CGameInstance::Get_PickedObject()
{
	return m_pPicking_Manager->Get_PickedObject();
}

void CGameInstance::Set_PickedObject(CGameObject* pObject)
{
	m_pPicking_Manager->Set_PickedObject(pObject);
}
...
_bool CGameInstance::isPicked_InLocalSpace(const _fvector& vPointA, const _fvector& vPointB, const _fvector& vPointC, const _gvector& vRayPos, _float3* pOut)
{
	return m_pPicking_Manager->isPicked_InLocalSpace(vPointA, vPointB, vPointC, vRayPos, pOut);
}

void CGameInstance::Add_PickingList(CGameObject* pObj)
{
	return m_pPicking_Manager->Add_PickingList(pObj);
}

void CGameInstance::Set_IsInUI(_bool isIn)
{
	m_pPicking_Manager->Set_IsInUI(isIn);
}

_bool CGameInstance::Is_Picking()
{
	return m_pPicking_Manager->Is_Picking();
}

_float3 CGameInstance::Get_PickingPos()
{
	return m_pPicking_Manager->Get_PickingPos();
}

_vector CGameInstance::Get_RayPos_World()
{
	return m_pPicking_Manager->Get_RayPos_World();
}

_vector CGameInstance::Get_RayDir_World()
{
	return m_pPicking_Manager->Get_RayDir_World();
}

_vector CGameInstance::Get_RayPos_Local()
{
	return m_pPicking_Manager->Get_RayPos_Local();
}

_vector CGameInstance::Get_RayDir_Local()
{
	return m_pPicking_Manager->Get_RayDir_Local();
}
