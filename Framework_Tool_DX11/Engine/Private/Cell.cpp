...
void CCell::Set_Point(const _float3* vPoint)
{
	m_vPoints[POINT_A] = vPoint[0];	
	m_vPoints[POINT_B] = vPoint[1];
	m_vPoints[POINT_C] = vPoint[2];

#ifdef _DEBUG
	m_pVIBuffer->Change_PointPos(m_vPoints);
